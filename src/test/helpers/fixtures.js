...
export const buildOneQuestionSurvey = function () {
  beforeEach(function () {
...
export const buildSurvey = function () {
  beforeEach(function () {
...
export const setCurrentCycleAndUserForProject = function () {
  beforeEach(function () {
...
export const createChapterWithCycles = function () {
...
export const nockClean = function () {
  nock.cleanAll()
  this.apiScope = null
}

export const nockIDMGraphQL = function (dataKey, data, {times = 1} = {}) {
...
export const nockIDMGetUser = function (user) {
  this.apiScope = nock(config.server.idm.baseURL)
    .post('/graphql')
    .reply(200, {
      data: {
...
export const nockIDMGetUsersById = function (users, {times = 1} = {}) {
  this.apiScope = nock(config.server.idm.baseURL)
    .post('/graphql')
    .times(times)
    .reply(200, {
...
export const nockIDMFindUsers = function (users, {times = 1} = {}) {
  this.apiScope = nock(config.server.idm.baseURL)
    .post('/graphql')
    .times(times)
    .reply(200, {
...
export const nockGetGoalInfo = function (goalNumber, {times = 1} = {}, overrideProps = {}) {
...
export const nockChatServiceCache = function (channels = [], users = []) {
...
export const ensureNoGlobalWindow = function () {
  before(function () {
